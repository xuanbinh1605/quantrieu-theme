    ...
    <div class="container mx-auto px-4">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="flex-1 lg:max-w-[calc(100%-320px)] overflow-hidden" data-animate="fade-up">
                ...
                <!-- Post Title -->
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mt-2 mb-4" style="line-height: 1.2;">
                    <?php the_title(); ?>
                </h1>
                ...
                <div class="prose prose-lg max-w-none
                    [&_h2]:text-2xl [&_h2]:md:text-3xl [&_h2]:lg:text-4xl [&_h2]:font-bold [&_h2]:my-6 [&_h2]:text-foreground
                    [&_h3]:text-xl [&_h3]:md:text-2xl [&_h3]:font-semibold [&_h3]:my-5 [&_h3]:text-foreground
                    [&_h4]:text-lg [&_h4]:font-semibold [&_h4]:my-4 [&_h4]:text-foreground
                    [&_h5]:text-base [&_h5]:font-semibold [&_h5]:my-4 [&_h5]:text-foreground
