<?php
/**
 * Custom Taxonomy: Danh mục tin tức (News Categories)
 *
...
function quantrieu_register_tin_tuc_taxonomy() {
    $labels = array(
        'name'                       => _x('Danh mục tin tức', 'taxonomy general name', 'quantrieu'),
        'singular_name'              => _x('Danh mục tin tức', 'taxonomy singular name', 'quantrieu'),
        ...
        'menu_name'                  => __('Danh mục tin tức', 'quantrieu'),
    );
    ...
    register_taxonomy('danh_muc_tin_tuc', array('tin_tuc'), $args);
}
add_action('init', 'quantrieu_register_tin_tuc_taxonomy');
